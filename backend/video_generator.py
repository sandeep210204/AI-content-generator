...
class VideoGenerator:
    ...
    def search_duckduckgo(self, query):
        try:
            ...
            results = ddgs.text(query, region="wt-wt", safesearch="moderate", timelimit=None, backend="auto", max_results=1)
            ...
            return "Error: Unable to fetch information from DuckDuckGo."
    ...
    def generate_speech(self, text, output_file="output_audio.wav"):
        try:
            ...
            # Convert to MP3
            wav_clip = AudioFileClip(output_file)
            mp3_file = "output_audio.mp3"
            wav_clip.write_audiofile(mp3_file)
            wav_clip.close()
